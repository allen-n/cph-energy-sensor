...
double circuitVal::get_iRMS() { return this->iRMS; }

double circuitVal::get_vRMS() { return this->vRMS; }

double circuitVal::get_pf() { return this->pf; }

double circuitVal::get_apparentP() { return this->apparentP; }

double circuitVal::get_realP() { return this->realP; }

double circuitVal::get_reactiveP() { return this->reactiveP; }

float *circuitVal::get_harmonics() { return this->harmonics; }
...
void circuitVal::addData(double iRMS, double vRMS, double pf, double apparentP,
  ...
  this->vRMS =
      (this->vRMS * this->_buff_size - this->vRMS_buff[this->ptr] + vRMS) /
      (double)this->_buff_size;
  this->vRMS_buff[this->ptr] = vRMS;

  this->pf = (this->pf * this->_buff_size - this->pf_buff[this->ptr] + pf) /
             (double)this->_buff_size;
  this->pf_buff[this->ptr] = pf;

  this->apparentP = (this->apparentP * this->_buff_size -
                     this->apparentP_buff[this->ptr] + apparentP) /
                    (double)this->_buff_size;
  this->apparentP_buff[this->ptr] = apparentP;

  this->realP =
      (this->realP * this->_buff_size - this->realP_buff[this->ptr] + realP) /
      (double)this->_buff_size;
  this->realP_buff[this->ptr] = realP;

  this->reactiveP = (this->reactiveP * this->_buff_size -
                     this->reactiveP_buff[this->ptr] + reactiveP) /
                    (double)this->_buff_size;
  this->reactiveP_buff[this->ptr] = reactiveP;

  for (int i = 0; i < this->_num_harmonics; i++) {
    this->harmonics[i] = (this->harmonics[i] * this->_buff_size -
