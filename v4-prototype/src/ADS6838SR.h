...
#define ADS8638_RANGE_CONFIG                                                   \
  0x0 // Ranges as selected through the configuration registers
...
#define ADS8638_POWER_DOWN                                                     \
  0x7 // Powers down the device immediately
...
public:
  ...
  void read8(uint16_t *out, uint8_t addr = ADS8638_REG_MANUAL,
             uint8_t range = ADS8638_RANGE_5V);
